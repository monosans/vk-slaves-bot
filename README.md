...
Пока что я смог понять 3 возможные причины такого поведения:
...
- Сервер игры отказывается присылать информацию в ответ, но при этом даёт работу и покупает рабов и оковы.

Возможно, ни один из перечисленных выше пунктов к Вам не относится. Над решением проблемы буду работать в ближайшее время.
