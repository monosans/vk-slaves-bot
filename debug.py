...
Доход в минуту: {profile['slaves_profit_per_min']}"""
            ...
            # Сох
            with open("buySlavesJob.json", "w") as f:
                dump(job_text, f, indent="\t")
            ...
            if config["buy_fetters"] == 1:
                ...
                with open("buySlavesFetter.json", "w") as f:
                    dump(fetter_text, f, indent="\t")
...
def buy_fetter():
    ...
    while True:
        try:
            ...
            with open("fetterStart.json", "w") as f:
                dump(start, f, indent="\t")
...
def job_slave():
    ...
    while True:
        try:
            ...
            with open("jobStart.json", "w") as f:
                dump(start, f, indent="\t")
